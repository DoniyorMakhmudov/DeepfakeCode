...
width = 700 
height = 1200 
cap = cv2.VideoCapture("Donik.mp4") 
 
result1=cv2.VideoWriter('generated_video_putin.mp4', cv2.VideoWriter_fourcc(*'MJPG'), 25, (700,1200)) 
cap.set(3, width) 
cap.set(4, height) 
...
while True: 
    ...
    # Define width and height before resizing
